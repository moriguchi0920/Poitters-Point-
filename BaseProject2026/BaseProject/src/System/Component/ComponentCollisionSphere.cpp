...
const matrix ComponentCollisionSphere::GetOldWorldMatrix() const
{
...
ComponentCollisionSphere::HitInfo ComponentCollisionSphere::IsHit(ComponentCollisionPtr col)
{
	...
	case ComponentCollision::CollisionType::BOX:
		return isHit(std::dynamic_pointer_cast<ComponentCollisionSphere>(shared_from_this()), std::dynamic_pointer_cast<ComponentCollisionBox>(col));
		break;
	}
