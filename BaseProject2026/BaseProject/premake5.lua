...
config_project("hlsl++", "StaticLib")
	...
	local SOURCE_PATH = build_path("opensource/hlslpp")
...
config_project("ImGui", "StaticLib")
	...
	local SOURCE_PATH = build_path("opensource/imgui")
	local IMGUI_PATH  = build_path("opensource/imgui")
...
config_project("ImGuizmo", "StaticLib")
	...
	local SOURCE_PATH = build_path("opensource/ImGuizmo")
	local IMGUI_PATH  = build_path("opensource/imgui")
...
config_project("implot", "StaticLib")
	...
	local SOURCE_PATH = build_path("opensource/implot")
...
config_project("im-neo-sequencer", "StaticLib")
	...
	local SOURCE_PATH = build_path("opensource/im-neo-sequencer")
	local IMGUI_PATH  = build_path("opensource/imgui")
...
config_project("sigslot", "StaticLib")
	...
	local SOURCE_PATH = build_path("opensource/sigslot/include/sigslot")
...
config_project("meshoptimizer", "StaticLib")
	...
	local SOURCE_PATH = build_path("opensource/meshoptimizer/src")
...
config_project("JoltPhysics", "StaticLib")
	...
	local SOURCE_PATH = build_path("opensource/JoltPhysics/Jolt")
	...
	includedirs {
		SOURCE_PATH,
		build_path("opensource"),
		build_path("opensource/JoltPhysics"),
	}
...
config_project("cereal", "StaticLib")
	...
	local SOURCE_PATH = build_path("opensource/cereal")
...
config_project("BaseProject", "WindowedApp")
	...
	local SOURCE_PATH = build_path("src")
	local DXLIB_PATH  = build_path("dxlib")
	local INI_PATH    = build_path("data")
	local SAMPLE_PATH = build_path("src/Sample")
	local DATA_PATH   = build_path("data")

	debugdir  (build_path("."))	-- 実行開始時のカレントディレクトリ
...
--	}
	...
	includedirs {
		...
		IMGUI_PATH,				-- ImGui
		build_path("opensource"),			-- オープンソース
		build_path("opensource/cereal/include"),
		build_path("opensource/JoltPhysics"),
		SAMPLE_PATH,
