...
//! @brief ベースディレクトリを返します
std::string GetBaseDirectory();

//! @brief Dataディレクトリを返します
std::string GetDataDirectory();

//! @brief ロードファイルダイアログ
//! @param directory ロード初期位置
//! @return ロードファイル名
std::string OpenFileDialog(const std::string& directory = "");

//! @brief 古いファイルをユニーク数値をつけてバックアップする。
//! @param fname ファイル名（パスを含む可能性がある文字列）。
//! @return バックアップしたサフィックスが追加されたファイル名。
